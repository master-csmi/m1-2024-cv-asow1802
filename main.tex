...
\simpleheader{headercolour}{Ablaye}{SOW}{Captain}{white}
...
\bg{cvgreen}{white}{About me}\\[0.1em]
...
\begin{tabular}{r p{0.6\textwidth} c}
    \cvdegree{2019}{Baccalaureate}{{mathematics and physical science}}{valdiodio ndiaye high school \color{headerblue}}{}{disney.png} \\
    \cvdegree{2022}{License}{mathematics,cryptography and security}{sheikh anta diop university of dakar \color{headerblue}}{}{medal.jpeg} \\
    \cvdegree{2024}{Licence}{applied mathematics}{University of Strasbourg \color{headerblue}}{}{medal.jpeg}
\end{tabular}
\end{minipage}\hfill
...
\begin{tabular}{r @{\hspace{0.5em}}l}
     ...
     \bg{skilllabelcolour}{iconcolour}{JS, R, Rust} & \barrule{0.1}{0.5em}{cvpurple} \\
...
\section*{Languages}
\begin{tabular}{l | ll}
\textbf{English} & A2 & {\phantom{x}\footnotesize mother tongue} \\
\textbf{French} & C2 & \pictofraction{\faCircle}{cvgreen}{3}{black!30}{1}{\tiny} \\
\textbf{Wolof} & C2 & \pictofraction{\faCircle}{cvgreen}{3}{black!30}{1}{\tiny} \\
...
{\small asow1502@gmail.com \icon{\faEnvelopeO}{cvgreen}{} 14 route de la Wantzenau(Strasbourg) \icon{\faMapMarker}{cvgreen}{} Tortuga \icon{\faPhone}{cvgreen}{} +33 7 63 44 13 40 \newline\icon{\faAt}{cvgreen}{} \protect\url{jack@sparrow.com}
}
\end{center}
\end{minipage}
